...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { photo_id: @slide.photo_id, position: @slide.position, slideshow_id: @slide.slideshow_id }
    end
  ...
  test "should update slide" do
    patch :update, id: @slide, slide: { photo_id: @slide.photo_id, position: @slide.position, slideshow_id: @slide.slideshow_id }
    assert_redirected_to slide_path(assigns(:slide))
  end
